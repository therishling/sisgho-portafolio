    ...
    public class ClienteController
    {
        ...
        public void LlenarGrid(DataGridView dt)
        {
            ...
            foreach (CLIENTE cliente in ListadoCliente()) {
                user = su.obtenerUsuarioID((int)cliente.USUARIO);
                dt.Rows.Add(cliente.IDCLIENTE, cliente.RUT, cliente.NOMBRE, cliente.RUBRO, cliente.DIRECCION, cliente.TELEFONO, cliente.USUARIO, user.NOMBRE, user.APELLIDO_PATERNO, user.APELLIDO_MATERNO, user.CORREO);
            }
