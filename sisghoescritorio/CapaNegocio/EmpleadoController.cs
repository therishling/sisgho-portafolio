...
namespace CapaNegocio
{
    public class EmpleadoController
    {
        ...
        public void LlenarGridEmp(DataGridView dge)
        {
            ...
            {
                user = su.obtenerUsuarioID((int)empleado.USUARIO);
                dge.Rows.Add(empleado.IDEMPLEADO,user.USUARIO1,user.NOMBRE,user.APELLIDO_PATERNO,user.APELLIDO_MATERNO,user.CORREO);
            }
        ...
        public bool AgregarEmpleado(string usuario, string nombre, string apellidop, string apellidom, string correo, string contraseña)
        {
            ...
            if (!this.BuscarUsuario(usuario))
            {
                ...
                user.PASSWORD = pc.generarContraseña(contraseña);
                user.NOMBRE = nombre;
                user.NOMBRE = nombre;
        ...
        public void LlenarCamposEmp(int idEmpleado, TextBox usuario, TextBox nombre, TextBox apellidop, TextBox apellidom, TextBox correo)
        {
            ...
            USUARIO user = su.obtenerUsuarioID((int)empleado.USUARIO);
        ...
        public void EliminarEmpleado(int id)
        {
            ...
            USUARIO user = su.obtenerUsuarioID((int)emp.USUARIO);
