...
namespace CapaNegocio
{
    public class ProveedorController
    {
        ...
        public void LlenarGrid(DataGridView dt)
        {
            ...
            {
                user = su.obtenerUsuarioID((int)prov.USUARIO);
                dt.Rows.Add(prov.IDPROVEEDOR, prov.RUBRO, prov.TELEFONO, prov.DESCRIPCION, prov.SITIOWEB, user.USUARIO1, user.NOMBRE, user.APELLIDO_PATERNO, user.APELLIDO_MATERNO, user.CORREO);
            }
        ...
        public void LlenarCampos(int idprov, TextBox usuario, TextBox nombre, TextBox apellidop, TextBox apellidom, TextBox correo, TextBox rubro, TextBox telefono, TextBox descrp, TextBox sitioweb, Label id)
        {
            ...
            USUARIO user = su.obtenerUsuarioID((int)prov.USUARIO);
