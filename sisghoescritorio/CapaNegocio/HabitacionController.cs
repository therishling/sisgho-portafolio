    ...
    public class HabitacionController
    {
        ...
        public void LlenarGrid(DataGridView dt)
        {
            ...
            foreach (HABITACION h in ListadoHabitacion())
            {
                ...
                dt.Rows.Add(h.IDHABITACION, h.NUMERO, h.TIPOCAMA, h.ACCESORIOS, h.PRECIO, estado);
            }
        ...
        public bool AgregarHabitacion(int numero, string tipoCama, string accesorios, int precio)
        {
            ...
            {
                MessageBox.Show("No se pudo crear la habitacion. "+ ex.Message, "Crear Habitacion", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
